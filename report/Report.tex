...
For $16\times16$ we get 5459.13 MFLOPS, 0.39 CPI, 0 cache miss rate.  For $256\times256$ we get 6449.8 MFLOPS, 0.45 CPI, 4.68\% L1D cache miss rate and 0.02\% L2 cache miss rate.  For $1024\times1024$ we get 4161.53 MFLOPS, 0.71 CPI, 5.34\% L1D cache miss rate and 4.9\% L2 cache miss rate.  Below is a plot of improvements achieved via various optimizations:
